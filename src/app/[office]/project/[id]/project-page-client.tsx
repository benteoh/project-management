...
export default function ProjectPageClient({
  ...
  return (
    <div className="bg-background flex min-h-0 flex-1 flex-col overflow-hidden">
          ...
          <div className="flex w-full min-w-0 items-start justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-1 text-sm">
                ...
                {project.officeName} · {formatProjectStatus(project.status)}
              </p>
            </div>
      ...
      <div
        className={`border-border bg-card mx-6 flex min-h-0 flex-1 flex-col border-x border-b ${activeTab === "Forecast" ? "overflow-y-auto" : "overflow-hidden"}`}
      >
        {activeTab === "Programme" && (
          <ProgrammeTab
            key={projectId}
